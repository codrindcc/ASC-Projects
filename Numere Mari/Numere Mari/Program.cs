...
namespace _Numere_Mari
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrintVector("Suma celor 2 vectori : ", sum);

            int[] newt = copyArray(t);
            int[] diff = DiffVectors(v, newt);
            PrintVector("Diferenta celor 2 vectori : ", diff);

            int[] multiplication = MultipleVectors(v, t);
            PrintVector("Rezultatul inmultirii celor doi vectori : ", multiplication);
